...
const AddProjectForm = ({
  ...
  function onSubmit(values: z.infer<typeof addNewProjectsSchema>) {
    ...
    if (profile && project) {
      ...
      axios
        .post("/api/project", { ...values, profileId: profile.id })
        .then((res) => {
  ...
  return (
    <div className="max-h-[75vh] overflow-y-auto px-2 pb-6 pt-2">
      <Form {...form}>
        <form className="space-y-5">
          <div className="flex flex-col md:flex-row gap-7">
            ...
            <div className="flex-1 flex flex-col gap-5">
              <FormLabel className="text-lg">Tech Stack </FormLabel>
              <div className="-mt-2">
              ...
              <div>
                ...
                <FormDescription>tech used for dev backend</FormDescription>
                <div className="grid grid-cols-2 gap-3 mt-2">
                  <CustomFormFieldCheckBoxProject
                    control={form.control}
                    name="express"
